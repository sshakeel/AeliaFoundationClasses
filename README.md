...
##Description
Aelia Foundation Classes implements some convenience classes that can be used by other plugins. It also extends some Core files by adding new events and features, while maintaining the compatibility with original ones.
