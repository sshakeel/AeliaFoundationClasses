...
?>
	...
	<div class="Tabs">
		<ul>
			<?php
				echo RenderTabItem(T('General Settings'), AELIAFOUNDATION_PLUGIN_GENERALSETTINGS_URL, $TabsClasses);
				echo RenderTabItem(T('Overrides'), AELIAFOUNDATION_PLUGIN_OVERRIDES_LIST_URL, $TabsClasses);
			?>
		</ul>
	</div>
